...
if (Symbol.dispose)
  DrillProcessResult.prototype[Symbol.dispose] =
    DrillProcessResult.prototype.free;
...
if (Symbol.dispose)
  ValidationResult.prototype[Symbol.dispose] = ValidationResult.prototype.free;
...
const DrillProcessResultFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_drillprocessresult_free(ptr >>> 0, 1),
      );
const ValidationResultFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_validationresult_free(ptr >>> 0, 1),
      );
