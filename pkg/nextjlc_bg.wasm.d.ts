...
export const __wbg_set_validationresult_layer_count: (a: number, b: number) => void;
...
export const process_d_codes: (a: number, b: number, c: number) => [number, number];
export const process_drill_files: (a: number, b: number, c: number, d: number) => number;
